...
/* NFB - get our tags from the request string */
var args = getArgs();

/* NFB - handling the email campaign data */
if (args.ec) {
	args.ntpg_sid = args.ec;
	args.ntpg_src = "ec";
}
var ntpg_src = args.ntpg_src || "";
var ntpg_sid = args.ntpg_sid || "";


var NTPT_IMGSRC = 'http://stats.nfb.ca/ntpagetag.gif';
...
/* NFB - additional values */
var NTPT_PGEXTRA = "ntpg_lg="+ntpg_lg+"&ntpg_src="+ntpg_src+"&ntpg_sid="+ntpg_sid+"&ntpg_app="+ntpg_app+"&ntpgi_project="+ntpgi_project;

/* NFB - function to get url parameters */
function getArgs() {
	var args = new Object();
